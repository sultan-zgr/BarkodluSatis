        ...
        public static void RaporSayfasiRaporu(DataGridView dgv)
        {
            ...
            for (int i = 0; i < dgv.Rows.Count; i++)
            {
                list.Add(new IslemOzet
                {
                    ...
                    AlisFiyatToplam = Islemler.DoubleYap(dgv.Rows[i].Cells["Alış Fiyat Toplam"].Value.ToString()),
                    Aciklama = dgv.Rows[i].Cells["Açıklama"].Value.ToString(),
        ...
        public static void StokRaporu(DataGridView dgv)
        {
            ...
            for (int i = 0; i < dgv.Rows.Count; i++)
            {
                list.Add(new Urun
                {
                    ...
                    UrunAdı=dgv.Rows[i].Cells["UrunAdı"].Value.ToString(),
