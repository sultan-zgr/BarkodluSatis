    ...
    static class Islemler
    {
        ...
        public static void StokAzalt(string barkod, double miktar)
        {
            using (var db = new BarkodDBEntities())
            {
                ...
                urunbilgi.Miktar -= miktar; //var olan miktardan dışarıdan gönderdiğimiz miktarı çıkaracak
                db.SaveChanges();
            }
        }
        public static void StokArtir(string barkod, double miktar)
        {
            ...
            {
                var urunbilgi = db.Urun.SingleOrDefault(x => x.Barkod == barkod);
                urunbilgi.Miktar += miktar; // var olan miktarın üstüne dışarıdan gönderdiğimiz miktarı ekliyoruz
                db.SaveChanges();
            }
